...
// ACKategories
#define COCOAPODS_POD_AVAILABLE_ACKategories
#define COCOAPODS_VERSION_MAJOR_ACKategories 2
#define COCOAPODS_VERSION_MINOR_ACKategories 0
#define COCOAPODS_VERSION_PATCH_ACKategories 0
